...
<section class="categories">
  ...
  <p>Find exactly what you need. Browse our extensive selection of computer
  hardware organized by component type.</p>
...
<section class="products">
  ...
  <div class="product-grid">
    ...
    <div class="product-card">
      ...
      <h4>Tenda AC6 Smart WiFi Router 1200Mbps High Speed Dual Band 2.4Ghz&5Ghz</h4>
...
<script>
  // index.php is a public page — all cart actions always redirect to Login
  ...
  function updateBadge() {} // no badge needed on public page
</script>
